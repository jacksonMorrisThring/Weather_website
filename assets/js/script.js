...
function handleCityName(cityName){
    ...
    var geolocatorRequestURL = 'https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/geo/1.0/direct?q=' + cityName + '&appid=93f009b07cdf38e8e5c9ff73cea6126b';
    ...
    .then(function (data) {
        ...
        var weatherRequestURL = 'https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/onecall?lat='+lattitude+'&lon='+longitude+'&exclude=hourly,daily,alerts,minutely&units=metric&appid=93f009b07cdf38e8e5c9ff73cea6126b';
